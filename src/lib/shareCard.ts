 ...
 *  it. Passed alongside the image as the native share sheet's caption
 *  text (see Results.tsx's shareImage) — the image itself still shows
 *  full names, for anyone actually sent the image directly. */
